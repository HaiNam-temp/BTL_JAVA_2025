...
public class UserService implements IUserService{
    ...
    public String loginSocial(UserLoginDTO userLoginDTO) throws Exception {
        ...
        // Kiểm tra Facebook Account ID
            ...
            List<User> users = userRepository.findAllByFacebookAccountId(userLoginDTO.getFacebookAccountId());

            if (users.size() > 1) {
                throw new IllegalStateException("Trùng nhiều tài khoản với cùng facebook_account_id = " + userLoginDTO.getFacebookAccountId());
            }
