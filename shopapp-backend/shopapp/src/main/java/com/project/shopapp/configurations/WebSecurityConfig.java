...
//orders
                            ...
                            .requestMatchers(HttpMethod.GET, String.format("%s/orders/user/**", apiPrefix)).authenticated()
                            .requestMatchers(HttpMethod.PUT, String.format("%s/orders/{id}/cancel", apiPrefix)).authenticated()
//order_details
                            .requestMatchers(HttpMethod.POST,
...
//admin dashboard - thống kê
                            .requestMatchers(HttpMethod.GET,
                                    String.format("%s/admin/dashboard/**", apiPrefix)).hasRole(Role.ADMIN)
